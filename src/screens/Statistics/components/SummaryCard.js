...
// // Thêm isDailyReport và customCardWidth vào props
// const SummaryCard = ({ title, totalRevenue, totalReports, change, value, icon, color, type, chartData, isDailyReport, customCardWidth }) => {
...
//     return (
//         // Sử dụng style array để áp dụng customCardWidth nếu có
...
//             {/* Sparkline - Chỉ hiển thị nếu KHÔNG phải báo cáo ngày và có đủ dữ liệu */}
...
//                     svg={{ stroke: changeColor, strokeWidth: 2 }}
//                     renderDot={() => null}
//                     showGrid={false}
//                 >
//                     <SparklinePath />
...
//         borderRadius: 8,
//         padding: 15,
//         // width: '48%', // Sẽ được override bởi customCardWidth hoặc giá trị mặc định trong component
//         marginBottom: 10,
//         shadowColor: "#000",
